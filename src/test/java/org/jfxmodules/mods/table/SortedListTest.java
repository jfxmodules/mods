...
public class SortedListTest {
   ...
   /**
    ...
    public void testSourceIndex() {
        ...
        final SortedList<Double> sorted = new SortedList(sourceList, Comparator.naturalOrder());
    ...
    public void testMutableElement() {
        ...
        SortedList<Person> sorted =  new SortedList(list, naturalOrder);
    ...
    public void testMutableElementUnsortedChain_rt39541() {
        ...
        SortedList<Person> sorted =  new SortedList(items, Comparator.naturalOrder());
    ...
    public void testMutableElementSortedFilteredChain() {
        ...
        SortedList<Person> sorted =  new SortedList<Person>(filtered, (x, y) -> x.name.get().compareTo(y.name.get()));
    ...
    private static final Comparator<Object> naturalOrder = new Comparator<Object>() {
            ...
            public int compare(Object o1, Object o2) {
                ...
                if (o1 instanceof Comparable) {
                    ...
                    Comparable<Object> casted = (Comparable<Object>) o1;  // cast is not safe, assumes the comparable interface implemented is Comparable<E> but it might be anything
    ...
    public void testNotComparable() {
        ...
        SortedList<Object> sorted = new SortedList(list, naturalOrder);
    ...
    public void testCompareNulls() {
        ...
        SortedList<String> sorted = new SortedList(list, naturalOrder);
...
/*
    ...
    public void testRemoveFromDuplicates() {
        ...
        SortedList<String> sorted = new SortedList(list, Comparator.naturalOrder());
    ...
    public void testAddAllOnEmpty() {
        list = FXCollections.observableArrayList();
        SortedList<String> sl = new SortedList(list, String.CASE_INSENSITIVE_ORDER);
        list.addAll("B", "A");
